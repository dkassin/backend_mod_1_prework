...
=begin
I choose to use the string data type for first name, is_hungry is a yes or no answer so I
choose to use a boolean, and number of pets is a question about a number so I used a number
variable.
=end
